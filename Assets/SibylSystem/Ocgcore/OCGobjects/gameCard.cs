...
public class gameCard : OCGobject
{
   ...
   // bool picLikeASquare = false;
    ...
    FlashingController insFlashONE(string color)
    {
		...
		UnityEngine.ColorUtility.TryParseHtmlString(color, out tcl);
        flash.flashingStartColor = tcl;
		UnityEngine.ColorUtility.TryParseHtmlString("000000", out tcl);
    ...
    public void flash_line_on()
    {
        ...
        if (MouseFlash==null)   
        {
            ...
            Color tcl = Color.yellow;
			UnityEngine.ColorUtility.TryParseHtmlString("ff8000", out tcl);
            MouseFlash.flashingStartColor = tcl;
			UnityEngine.ColorUtility.TryParseHtmlString("ffffff", out tcl);
