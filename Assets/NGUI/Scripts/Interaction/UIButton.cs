...
public class UIButton : UIButtonColor
{
    ...
    public string mTextureOutNormal;
    public string mTextureOutPressed;

    UITexture texure2d;

    public string TextureOutNormal
    {
        get
        {
            return mTextureOutNormal;
        }
        set
        {
            mTextureOutNormal = value;
        }
    }

    public string TextureOutPressed
    {
        get
        {
            return mTextureOutPressed;
        }
        set
        {
            mTextureOutPressed = value;
        }
    }
